...
/// This state machine models the typical cycle of clothes as they make their way through the laundary
/// cycle several times before ultimately becoming tattered.
pub struct ClothesMachine ;

/// Models a piece of clothing throughout the lifecycle.
...
pub enum ClothesState {
    ...
    Dirty(u64),
    /// Wet clothes. With some given life left. The clothes are assumed to be wet because they were
    /// just washed. And washing clothes is the only modeled way to get them wet.
    Wet(u64),
